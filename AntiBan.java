...
public class AntiBan {
    public int ANTIBAN_RATE = 75; // This is the frequency rate for anti-ban actions (in % terms - 100% = frequent, 0% = never
    public int MIN_WAIT_NO_ACTION = 5; // This is the minimum time to wait if no action was taken
    public int MAX_WAIT_NO_ACTION = 5; // This is the maximum time to wait if no action was taken
    private AbstractScript s; // Script
    private String STATUS = "Idling"; // Current anti-ban status
    private Skill[] STATS_TO_CHECK = { Skill.MINING }; // This is used for determining which stats to randomly check
